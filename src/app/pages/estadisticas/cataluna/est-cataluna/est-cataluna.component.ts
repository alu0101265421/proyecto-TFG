...
@Component({
  selector: 'app-est-cataluna',
  templateUrl: './est-cataluna.component.html',
  styleUrls: ['./est-cataluna.component.css'],
})
export class EstCatalunaComponent implements OnInit {
