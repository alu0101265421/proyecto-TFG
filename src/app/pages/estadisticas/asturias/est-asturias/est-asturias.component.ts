...
@Component({
  selector: 'app-est-asturias',
  templateUrl: './est-asturias.component.html',
  styleUrls: ['./est-asturias.component.css'],
})
export class EstAsturiasComponent implements OnInit {
