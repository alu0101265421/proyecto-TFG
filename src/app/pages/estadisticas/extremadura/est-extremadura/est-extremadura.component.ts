...
@Component({
  selector: 'app-est-extremadura',
  templateUrl: './est-extremadura.component.html',
  styleUrls: ['./est-extremadura.component.css'],
})
export class EstExtremaduraComponent implements OnInit {
