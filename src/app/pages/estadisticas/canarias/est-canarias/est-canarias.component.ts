...
@Component({
  selector: 'app-est-canarias',
  templateUrl: './est-canarias.component.html',
  styleUrls: ['./est-canarias.component.css'],
})
export class EstCanariasComponent implements OnInit {
