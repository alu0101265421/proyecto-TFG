...
@Component({
  selector: 'app-ux-asturias',
  templateUrl: './ux-asturias.component.html',
  styleUrls: ['./ux-asturias.component.css'],
})
export class UxAsturiasComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.resultadosUX = await this.uxService.analizarUX('https://www.jgpa.es/');
