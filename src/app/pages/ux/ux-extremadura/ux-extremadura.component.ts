...
@Component({
  selector: 'app-ux-extremadura',
  templateUrl: './ux-extremadura.component.html',
  styleUrls: ['./ux-extremadura.component.css'],
})
export class UxExtremaduraComponent implements OnInit {
