...
@Component({
  selector: 'app-ux-galicia',
  templateUrl: './ux-galicia.component.html',
  styleUrls: ['./ux-galicia.component.css'],
})
export class UxGaliciaComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.resultadosUX = await this.uxService.analizarUX(
      'https://www.es.parlamentodegalicia.es/'
    );
