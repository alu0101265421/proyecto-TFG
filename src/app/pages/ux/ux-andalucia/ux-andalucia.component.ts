...
@Component({
  selector: 'app-ux-andalucia',
  templateUrl: './ux-andalucia.component.html',
  styleUrls: ['./ux-andalucia.component.css'],
})
export class UxAndaluciaComponent implements OnInit {
